...
#
# This file is derived from Brax 0.12.3 (training/replay_buffers.py) and has been modified
# by the CRAX Authors: adds `PytreeUniformSamplingQueue`, which stores the buffer as a pytree instead of a
# flattened array so entries are not padded to the size of the largest leaf.
