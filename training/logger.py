...
#
# This file is derived from Brax 0.12.3 (training/logger.py) and has been modified
# by the CRAX Authors: replaced with `MetricsLogger`, which buffers environment, step and training metrics
# and flushes them on a fixed step interval.
