...
#
# This file is derived from Brax 0.12.3 (training/types.py) and has been modified
# by the CRAX Authors: `UInt64` arithmetic casts the shift operand with `np.uint64` (NumPy 2 removed the
# implicit cast) and tolerates non-array operands.

"""Brax training types."""

from typing import Any, Mapping, NamedTuple, Tuple, TypeVar, Union

from training.acme.types import NestedArray
import flax
import jax
