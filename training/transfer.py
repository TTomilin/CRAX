...
Example usage:
    ...
    from training.agents import ppo, ppo_lag
...
from training.run_utils import filter_kwargs_for_fn, record_episode_video
...
def quick_transfer_comparison(
    ...
    from training.agents import ppo
    from training.agents import ppo_lag
    from training.agents import ppo_pid
    from training.agents import focops
    from training.agents import p3o
