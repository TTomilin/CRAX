...
#
# This file is derived from Brax 0.12.3 (training/agents/ppo/networks.py) and has been modified
# by the CRAX Authors: adds an optional `cost_value_network` head.
