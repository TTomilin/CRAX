...
#
# This file is derived from Brax 0.12.3 (training/agents/ppo/losses.py) and has been modified
# by the CRAX Authors: adds cost-value targets for the constrained variants and computes the shared vision
# latent once per batch.
