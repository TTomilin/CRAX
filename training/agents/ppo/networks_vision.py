...
#
# This file is derived from Brax 0.12.3 (training/agents/ppo/networks_vision.py) and has been modified
# by the CRAX Authors: adds cost-value CNN heads and an option to share one encoder across heads.

"""PPO vision networks."""

from typing import Any, Callable, Mapping, Optional, Sequence, Tuple

from training import distribution
from training import networks
from training import types
from training.agents.ppo.networks import PPONetworks
