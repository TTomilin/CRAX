...
#
# This file is derived from Brax 0.12.3 (training/agents/sac/networks.py) and has been modified
# by the CRAX Authors: adds `make_sac_networks_vision` (CNN policy and CNN Q-critic).
...
def make_sac_networks_vision(
  ...
  """Make vision SAC networks (CNN policy + CNN Q-critic, each own encoder)."""
  parametric_action_distribution = distribution.NormalTanhDistribution(
      event_size=action_size
  )
