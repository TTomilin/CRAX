...
#
# This file is derived from Brax 0.12.3 (training/agents/sac/networks.py) and has been
# substantially modified by the CRAX Authors: adds cost-Q critic networks alongside the reward critics.
