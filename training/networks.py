...
#
# This file is derived from Brax 0.12.3 (training/networks.py) and has been modified
# by the CRAX Authors: adds `MLPHead`, `VisionEncoder`, `VisionMLP`, `VisionMLPHead` and `VisionQMLP` for
# CNN policies with optional shared encoders, plus spectral-normalised dense layers.
...
from training.spectral_norm import SNDense
