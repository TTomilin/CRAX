...
#
# This file is derived from Brax 0.12.3 (io/mjcf.py) and has been modified
# by the CRAX Authors: collision functions are loaded from `crax.mjx.collisions` (falling back to
# `mujoco.mjx`) so that CRAX's additional collision types are available to the loader.
...
import mujoco
try:
    from crax.mjx import collisions as mjx
