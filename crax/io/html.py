...
import crax
from crax.base import State, System
from crax.io import json
...
def render_from_json(
  ...
  html_path = epath.resource_path('crax') / 'visualizer/index.html'
  template = jinja2.Template(html_path.read_text())

  js_url = base_url
  if base_url is None:
    base_url = 'https://cdn.jsdelivr.net/gh/google/brax'
    js_url = f'{base_url}@v{crax.__version__}/brax/visualizer/js/viewer.js'
