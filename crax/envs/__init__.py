...
#
# This file is derived from Brax 0.12.3 (envs/__init__.py) and has been modified
# by the CRAX Authors: the environment registry is replaced with the CRAX safety suites, and
# `get_environment` applies difficulty levels and the optional GPU pixel-observation wrapper.
