...
Usage:
    ...
    # or via registry:
    env = crax.envs.get_environment("safe_velocity_ant", level=1)
"""
...
from crax.envs.hopper import Hopper
from crax.envs.humanoid import Humanoid
from crax.envs.swimmer import Swimmer
from crax.envs.velocity_constraints import (
...
from crax.envs.walker2d import Walker2d
