...
#
# This file is derived from Brax 0.12.3 (envs/humanoidstandup.py) and has been modified
# by the CRAX Authors: loads the CRAX `envs/assets/safe/` model XML.
...
class HumanoidStandup(PipelineEnv):
  ...
  def __init__(self, backend='generalized', **kwargs):
    path = epath.resource_path('crax') / 'envs/assets/safe/humanoidstandup.xml'
    sys = mjcf.load(path)
