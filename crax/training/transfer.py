...
Example usage:
    ...
    from crax.training.agents import ppo, ppo_lag
...
def quick_transfer_comparison(
    ...
    from crax.training.agents import ppo
    from crax.training.agents import ppo_lag
    from crax.training.agents import ppo_pid
    from crax.training.agents import focops
    from crax.training.agents import p3o
