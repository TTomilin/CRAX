"""Swimmer environment with a velocity safety constraint."""
...
class SwimmerVelocityConstrained(Swimmer):
    """Swimmer locomotion with a binary velocity constraint cost."""

    def __init__(
            self,
            velocity_threshold: float = 0.2282,
    ...
    def step(self, state: State, action: jax.Array) -> State:
        ...
        x_velocity = compute_velocity(
            pipeline_state0.q[0], pipeline_state.q[0], self.dt
        )
