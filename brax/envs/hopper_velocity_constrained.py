"""Hopper environment with a velocity safety constraint."""
...
class HopperVelocityConstrained(Hopper):
    """Hopper locomotion with a binary velocity constraint cost."""

    def __init__(
            self,
            velocity_threshold: float = 0.7402,
