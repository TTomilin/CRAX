"""Halfcheetah environment with a velocity safety constraint."""
...
class HalfcheetahVelocityConstrained(Halfcheetah):
    """Halfcheetah locomotion with a binary velocity constraint cost."""

    def __init__(
            self,
            velocity_threshold: float = 3.2096,
